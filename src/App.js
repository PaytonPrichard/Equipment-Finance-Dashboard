            ...
            {activeTab === 'screening' && (
              <>
                <div className="ml-auto flex items-center gap-2">
                  ...
                  {valid && <ExportPanel summaryText={summaryText} inputs={inputs} metrics={metrics} riskScore={riskScore} recommendation={recommendation} screeningResult={screeningResult} profile={profile} moduleLabel={moduleLabel} moduleKey={activeModule} factors={mod.describeFactors ? mod.describeFactors(inputs, metrics, riskScore) : []} structure={structure} stressResults={stressResults} />}
