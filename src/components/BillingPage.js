...
const PLANS = [
  ...
  },
  {
    ...
    features: ['Up to 10 users', 'Everything in Analyst', 'Unlimited deals', 'Firm-branded memo export', 'Shared pipeline & analytics', 'Audit trail', 'Custom scoring weights', 'API & webhook integrations', 'Priority support'],
    highlight: true,
