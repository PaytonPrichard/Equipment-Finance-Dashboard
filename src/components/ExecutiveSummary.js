...
function generateTakeaways(inputs, metrics, riskScore, recommendation) {
  ...
  const factorDescriptions = {
    ...
    inventoryQuality: 'Strong inventory turnover and low obsolescence make this the deal\'s best attribute.',
  ...
  const weakDescriptions = {
    ...
    arQuality: 'The receivables aging profile is concerning. A significant portion of AR is past due, reducing the effective borrowing base.',
