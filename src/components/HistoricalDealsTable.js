...
const STATUS_STYLE = {
  ...
  'Paid Off': { bg: 'bg-gold-500/[0.08]', border: 'border-gold-500/15', text: 'text-gold-400' },
    ...
    <div className="space-y-6 animate-fade-in-up">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          ...
          { v: `${Math.round(((stats.correct + stats.conservative) / stats.t) * 100)}%`, l: 'Model Accuracy', c: 'text-gold-400', bg: 'bg-gold-500/[0.06] border border-gold-500/15' },
        ].map((s) => (
      ...
      <div className="flex items-center gap-6 text-[10px] text-slate-600 pt-2">
        ...
        <span className="flex items-center gap-1.5">
          <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" className="text-gold-400" strokeWidth="2">
            <circle cx="12" cy="12" r="10" />
            <line x1="12" y1="8" x2="12" y2="12" />
            <line x1="12" y1="16" x2="12.01" y2="16" />
          </svg>
