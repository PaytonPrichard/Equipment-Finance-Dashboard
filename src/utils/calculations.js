// ============================================================
// Equipment Finance Deal Screening — Calculation Engine
// ============================================================

// ------- Market Assumptions (update periodically) -------
export const DEFAULT_SOFR = 0.045; // fallback if FRED API unavailable
// Legacy alias — components should migrate to DEFAULT_SOFR
export const CURRENT_SOFR = DEFAULT_SOFR;
export const EXISTING_DEBT_SERVICE_RATE = 0.08; // Assumed blended rate on existing debt

const BASE_SPREAD_BPS = 200;

const CREDIT_SPREAD_BPS = {
  Strong: -75,
  Adequate: 0,
  Weak: 200,
  'Not Rated': 100,
...
const FMV_RESIDUAL_PCT = {
  'Heavy Machinery': 0.15,
  'Vehicles/Fleet': 0.25,
  'Rail Cars': 0.20,
  'Marine Vessels': 0.15,
  'Aircraft/Helicopters': 0.20,
...
// Linear interpolation between breakpoints for smoother, more accurate scoring.
// breakpoints: [[inputValue, score], ...] sorted ascending by inputValue.
function lerp(value, breakpoints) {
...
export function calculateRiskScore(inputs, metrics) {
  ...
  const conditionBonus = inputs.equipmentCondition === 'New' ? 8 : 0;
